...
const ServiciosConductores = () => {
  ...
  return (
    <div>
      <Servicios2 setServicios={setServicios} servicios={servicios} MovilesState={MovilesState} onUpdateServicios={onUpdateServicios} handleUpdateMoviles={handleUpdateMoviles} />
    </div>
  )
}
