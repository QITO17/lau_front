...
const Servicio2 = ({
  ...
  const imprimir = (data) => {
    ...
    const payload =
      `{"nombreImpresora":"EPSON TM-T(180dpi) Receipt6",
      ...
      ,{"nombre":"Feed","argumentos":[1]},{"nombre":"EstablecerTamañoFuente","argumentos":[2,1]},{"nombre":"EstablecerEnfatizado","argumentos":[false]},
